Pod::Spec.new do |s|
    ...
    s.source                = { :http => 'https://raw.githubusercontent.com/FutureWorkshops/AppRailPreviewRepository-iOS/main/MWContentDisplayPlugin/'1.5.3'/MWContentDisplayPlugin.zip' }
    s.platform              = :ios
    s.swift_version         = '5'
