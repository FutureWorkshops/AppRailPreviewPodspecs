Pod::Spec.new do |s|
    ...
    s.source                = { :http => 'https://raw.githubusercontent.com/FutureWorkshops/AppRailPreviewRepository-iOS/main/MWInnovatricsDOTPlugin/0.1.2/MWInnovatricsDOTPlugin.zip' }
    s.platform              = :ios
    s.swift_version         = '5'
