Pod::Spec.new do |s|
    ...
    s.source                = { :http => 'https://raw.githubusercontent.com/FutureWorkshops/AppRailPreviewRepository-iOS/main/MWPushNotificationsPlugin/0.2.2/MWPushNotificationsPlugin.zip' }
    s.platform              = :ios
    s.swift_version         = '5'
