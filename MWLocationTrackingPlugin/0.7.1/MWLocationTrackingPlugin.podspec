Pod::Spec.new do |s|
    ...
    s.source                = { :http => 'https://raw.githubusercontent.com/FutureWorkshops/AppRailPreviewRepository-iOS/main/MWLocationTrackingPlugin/0.7.1/MWLocationTrackingPlugin.zip' }
    s.platform              = :ios
    s.swift_version         = '5'
