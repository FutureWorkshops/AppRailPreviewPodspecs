Pod::Spec.new do |s|
  ...
  s.author                = { 'Future Workshops' => 'info@futureworkshops.com' }
    s.source                = { :http => 'https://raw.githubusercontent.com/FutureWorkshops/AppRailPreviewRepository-iOS/main/MWStretchyHeaderPlugin/1.1.1/MWStretchyHeaderPlugin.zip' }
  s.platform              = :ios
  s.swift_version         = '5'
