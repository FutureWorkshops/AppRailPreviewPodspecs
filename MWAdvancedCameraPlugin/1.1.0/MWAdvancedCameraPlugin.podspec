Pod::Spec.new do |s|
  ...
  s.author                = { 'Future Workshops' => 'info@futureworkshops.com' }
    s.source                = { :http => 'https://raw.githubusercontent.com/FutureWorkshops/AppRailPreviewRepository-iOS/main/MWAdvancedCameraPlugin/1.1.0/MWAdvancedCameraPlugin.zip' }
  s.platform              = :ios
  s.swift_version         = '5'
