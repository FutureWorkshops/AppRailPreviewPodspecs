Pod::Spec.new do |s|
  ...
  s.author                = { 'Future Workshops' => 'info@futureworkshops.com' }
    s.source                = { :http => 'https://raw.githubusercontent.com/FutureWorkshops/AppRailPreviewRepository-iOS/main/MWUHCWNetworkServicePlugin/0.5.5/MWUHCWNetworkServicePlugin.zip' }
  s.platform              = :ios
  s.swift_version         = '5'
