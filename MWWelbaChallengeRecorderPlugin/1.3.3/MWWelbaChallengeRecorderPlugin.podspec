Pod::Spec.new do |s|
  ...
  s.author                = { 'Future Workshops' => 'info@futureworkshops.com' }
    s.source                = { :http => 'https://raw.githubusercontent.com/FutureWorkshops/AppRailPreviewRepository-iOS/main/MWWelbaChallengeRecorderPlugin/1.3.3/MWWelbaChallengeRecorderPlugin.zip' }
  s.platform              = :ios
  s.swift_version         = '5'
