Pod::Spec.new do |s|
    ...
    s.source                = { :http => 'https://raw.githubusercontent.com/FutureWorkshops/AppRailPreviewRepository-iOS/main/MWInAppPurchasesPlugin/0.1.1/MWInAppPurchasesPlugin.zip' }
    s.platform              = :ios
    s.swift_version         = '5'
